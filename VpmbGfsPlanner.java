...
public class VpmbGfsPlanner {
    ...
    public VpmbGfsPlanner(double gfHighSetting) {
    ...
    public void generateAscentSchedule(double startDepthMeters, GasMix bottomGas, GasMix decoGas, double gasSwitchDepth) {
        System.out.println("\n========================================================");
        System.out.println("          AUTO-GENERATED VPM-B/GFS DECO SCHEDULE        ");
        System.out.println("========================================================");
        ...
        while (currentDepth > 0) {
            ...
            while (loopGuard < 120) { // Safety guard cap to prevent infinite loop stalls
                loopGuard++;
        ...
        System.out.println("--------------------------------------------------------");
        System.out.println(">>> 0m              SURFACE      Welcome back up safely.");
        System.out.println("========================================================");
    }

    public static void main(String[] args) {
        VpmbGfsPlanner planner = new VpmbGfsPlanner(0.90);
        GasMix bottomGas = new GasMix(0.16, 0.50, "Trimix 16/50");
        GasMix decoGas = new GasMix(0.50, 0.0, "Nitrox 50%");
        
        planner.executeBottomPhase(60.0, 30.0, bottomGas);
        planner.generateAscentSchedule(60.0, bottomGas, decoGas, 21.0);
    }
}
