...
**Units:** 157 total; 59 unread; 53 in progress; 40 read; 5 verified.
...
| 7 | UI-SETTINGS-CONTROLS, UI-VPM-RUNNER | 595 | ENG-VPM | Settings restoration and VPM invocation contracts READ |
