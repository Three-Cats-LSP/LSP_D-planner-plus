...
| R39 | UI-CSS-FOUNDATION, UI-CSS-MODES | 782 | - | V4 R39: Foundation and mode CSS risk-first READ; current lines: 782; sessions: 2 |
| R40 | UI-CSS-CONTROLS | 559 | - | V4 R40: Controls CSS risk-first READ; current lines: 559; sessions: 1 |
| R41 | UI-CSS-RESULTS | 1078 | - | V4 R41: Results CSS risk-first design-lock READ; current lines: 1078; sessions: 2 |
