...
**Epoch:** `v3-full-reset`
**Units:** 178 total; 0 unread; 0 in progress; 1 read; 177 verified.
...
| 25 | UI-SETTINGS, UI-UNIT-HELPERS, UI-UNIT-SWITCHING | 1198 | - | Settings persistence and unit helpers READ |
