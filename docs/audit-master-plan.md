...
| 7 | Markup, base CSS, and current design-lock re-review | R34, R35, R36, R37, R38, R39, R40, R41, R42, R43 |
...
| R07 | UI-DECO-PHYSICS, UI-SCHEDULE-INPUTS | 664 | ENG-ZHL-CCR | V4 R07: Deco physics and schedule inputs risk-first READ; current lines: 664; sessions: 2 |
...
| R20 | APP-EXPORT | 3394 | - | V4 R20: Export text/PDF risk-first READ; current lines: 3394; sessions: 6 |
...
| R25 | APP-SERVICE-WORKER, UI-PWA-LIFECYCLE, APP-MANIFEST | 437 | - | V4 R25: PWA/service-worker lifecycle risk-first READ; current lines: 437; sessions: 1 |
...
| R39 | UI-CSS-FOUNDATION, UI-CSS-MODES | 758 | - | V4 R39: Foundation and mode CSS risk-first READ; current lines: 758; sessions: 2 |
| R40 | UI-CSS-CONTROLS | 548 | - | V4 R40: Controls CSS risk-first READ; current lines: 548; sessions: 1 |
| R41 | UI-CSS-RESULTS | 1075 | - | V4 R41: Results CSS risk-first design-lock READ; current lines: 1075; sessions: 2 |
