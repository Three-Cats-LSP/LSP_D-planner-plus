...
**Epoch:** `v3-full-reset`
**Units:** 205 total; 0 unread; 89 in progress; 4 read; 112 verified.
...
|---:|---|---:|---|---|
| 1 | UI-MARKUP-HEADER | 730 | - | V3 cycle 1: header markup partial READ; SUITE-UI-STRUCTURE must be green |
...
| 7 | UI-CSS-RESULTS | 970 | - | Results CSS READ (2 bounded sessions) |
