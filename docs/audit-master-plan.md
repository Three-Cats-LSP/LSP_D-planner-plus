...
| R24 | UI-BOOT | 2434 | - | V4 R24: index.html shell boot region risk-first READ; current lines: 2414; sessions: 5 |
...
| R42 | UI-PLANNER-SHELL, UI-RESULTS-PANEL | 716 | - | V4 R42: Planner shell and results panel design-lock READ; current lines: 716; sessions: 2 |
