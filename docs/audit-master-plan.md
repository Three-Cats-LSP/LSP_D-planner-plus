...
**Epoch:** `v3-full-reset`
**Units:** 179 total; 0 unread; 10 in progress; 1 read; 168 verified.
...
| 11 | UI-GAS-INPUTS, UI-GAS-CARDS | 508 | ENG-ZHL-GAS | Gas card UI READ |
...
| 16 | UI-TOOLS-PROFILE, UI-PLOT-INIT | 731 | - | Profile tool and plot init READ |
...
| 25 | UI-SETTINGS, UI-UNIT-HELPERS, UI-UNIT-SWITCHING | 1209 | - | Settings persistence and unit helpers READ |
