...
| R24 | UI-BOOT | 2446 | - | V4 R24: index.html shell boot region risk-first READ; current lines: 2414; sessions: 5 |
...
| R41 | UI-CSS-RESULTS | 1023 | - | V4 R41: Results CSS risk-first design-lock READ; current lines: 1023; sessions: 2 |
