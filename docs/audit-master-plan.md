...
**Epoch:** `v3-full-reset`
**Units:** 179 total; 0 unread; 14 in progress; 1 read; 164 verified.
...
| 11 | UI-GAS-INPUTS, UI-GAS-CARDS | 512 | ENG-ZHL-GAS | Gas card UI READ |
...
| 25 | UI-SETTINGS, UI-UNIT-HELPERS, UI-UNIT-SWITCHING | 1194 | - | Settings persistence and unit helpers READ |
