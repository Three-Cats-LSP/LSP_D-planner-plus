...
| R24 | UI-BOOT | 2432 | - | V4 R24: index.html shell boot region risk-first READ; current lines: 2414; sessions: 5 |
...
| R34 | UI-MARKUP-HEADER | 755 | - | V4 R34: Header markup risk-first READ; current lines: 755; sessions: 2 |
...
| R38 | UI-MARKUP-TOOLS, UI-MARKUP-MODALS | 617 | - | V4 R38: Tools and modal markup risk-first READ; current lines: 612; sessions: 2 |
...
| R42 | UI-PLANNER-SHELL, UI-RESULTS-PANEL | 709 | - | V4 R42: Planner shell and results panel design-lock READ; current lines: 709; sessions: 2 |
