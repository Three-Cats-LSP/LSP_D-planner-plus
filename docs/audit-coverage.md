...
| worker | 2 | 0 | 0 | 0 | 2 |
| **Total** | **205** | **0** | **92** | **3** | **110** |

## Units

| Unit | Layer | Source | Lines | Priority | Status | Evidence |
|---|---|---|---:|---|---|---|
| UI-BOOT | web_runtime | `index.html:1` | 2411 | P2 | IN_PROGRESS | - |
...
| UI-UNIT-HELPERS | web_runtime | `index.html:2923` | 529 | P1 | IN_PROGRESS | - |
| UI-UNIT-SWITCHING | web_runtime | `index.html:3452` | 378 | P1 | IN_PROGRESS | - |
| UI-ZHL-DELEGATES | web_runtime | `index.html:3830` | 141 | P0 | VERIFIED | REG-15, REG-16, REG-18 |
| UI-CCR-DELEGATES | web_runtime | `index.html:3971` | 370 | P0 | IN_PROGRESS | - |
| UI-DECO-PHYSICS | web_runtime | `index.html:4341` | 232 | P0 | IN_PROGRESS | - |
| UI-SCHEDULE-INPUTS | web_runtime | `index.html:4573` | 373 | P0 | IN_PROGRESS | - |
| UI-SETTINGS-CONTROLS | web_runtime | `index.html:4946` | 399 | P1 | IN_PROGRESS | - |
| UI-VPM-RUNNER | web_runtime | `index.html:5345` | 473 | P0 | IN_PROGRESS | - |
| UI-ZHL-RUNNER-SETUP | web_runtime | `index.html:5818` | 131 | P0 | IN_PROGRESS | - |
| UI-ZHL-RUNNER-ENGINE | web_runtime | `index.html:5949` | 349 | P0 | IN_PROGRESS | - |
| UI-ZHL-HEADLESS-HELPERS | web_runtime | `index.html:6298` | 201 | P1 | VERIFIED | EXT-05, COV-01 |
| UI-ZHL-HEADLESS-ENGINE | web_runtime | `index.html:6499` | 387 | P0 | VERIFIED | EXT-05, COV-01 |
| UI-PLOT-INIT | web_runtime | `index.html:6886` | 493 | P2 | IN_PROGRESS | - |
| UI-TOOLS-TISSUES | web_runtime | `index.html:7379` | 310 | P2 | IN_PROGRESS | - |
| UI-TOOLS-EXPOSURE | web_runtime | `index.html:7689` | 225 | P1 | IN_PROGRESS | - |
| UI-TOOLS-GF | web_runtime | `index.html:7914` | 316 | P2 | IN_PROGRESS | - |
| UI-SETTINGS | web_runtime | `index.html:8230` | 381 | P1 | IN_PROGRESS | - |
| UI-PROFILE-PRESETS | web_runtime | `index.html:8611` | 508 | P2 | IN_PROGRESS | - |
| UI-CONFIG-PRESETS | web_runtime | `index.html:9119` | 185 | P2 | VERIFIED | EXT-05, COV-01 |
| UI-APP-INIT | web_runtime | `index.html:9304` | 172 | P1 | IN_PROGRESS | - |
| UI-PWA-LIFECYCLE | pwa | `index.html:9476` | 84 | P1 | IN_PROGRESS | - |
...
| UI-CSS-RESULTS | web_css | `lsp-dplanner-results.css:1` | 970 | P1 | IN_PROGRESS | REG-89, REG-90, REG-91, REG-92, REG-93, REG-94 |
...
| UI-MARKUP-TEC-PLANNER | web_markup | `ui/markup-tec-planner.html:1` | 570 | P1 | IN_PROGRESS | - |
...
| UI-GAS-CARDS | ui_core | `gas-cards-core.js:238` | 311 | P1 | IN_PROGRESS | - |
...
| APP-CONTINGENCY | ui_core | `contingency-core.js:1` | 577 | P1 | IN_PROGRESS | - |
...
| TOOL-RUN-AUDIT-COVERAGE-SUITE-PY | tooling | `tools/run_audit_coverage_suite.py:1` | 91 | P0 | IN_PROGRESS | - |
...
| TEST-UI-VISUAL-CONTRACT-REGRESSION | test_infrastructure | `dev/ui_visual_contract_regression.py:1` | 1628 | P0 | IN_PROGRESS | REG-100, REG-101, REG-102, REG-103, REG-104, REG-105, REG-106, REG-107, REG-108, REG-109, REG-110, REG-111 |
