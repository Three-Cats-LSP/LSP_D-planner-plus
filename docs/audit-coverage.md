...
| worker | 2 | 0 | 0 | 0 | 2 |
| **Total** | **207** | **0** | **96** | **3** | **108** |

## Units

| Unit | Layer | Source | Lines | Priority | Status | Evidence |
|---|---|---|---:|---|---|---|
| UI-BOOT | web_runtime | `index.html:2` | 2410 | P2 | IN_PROGRESS | - |
| UI-RUNTIME-BOOTSTRAP | web_runtime | `index.html:2412` | 218 | P1 | VERIFIED | EXT-05, COV-01 |
| UI-ALGORITHM-SETTINGS | web_runtime | `index.html:2630` | 293 | P1 | IN_PROGRESS | - |
| UI-UNIT-HELPERS | web_runtime | `index.html:2923` | 163 | P1 | IN_PROGRESS | - |
| UI-ZHL-HEADLESS-HELPERS | web_runtime | `index.html:3086` | 201 | P1 | VERIFIED | EXT-05, COV-01 |
| UI-ZHL-HEADLESS-ENGINE | web_runtime | `index.html:3287` | 387 | P0 | VERIFIED | EXT-05, COV-01 |
| UI-PLOT-INIT | web_runtime | `index.html:3674` | 493 | P2 | IN_PROGRESS | - |
| UI-TOOLS-TISSUES | web_runtime | `index.html:4167` | 310 | P2 | IN_PROGRESS | - |
| UI-TOOLS-EXPOSURE | web_runtime | `index.html:4477` | 233 | P1 | IN_PROGRESS | - |
| UI-SETTINGS | web_runtime | `index.html:4710` | 386 | P1 | IN_PROGRESS | - |
| UI-PROFILE-PRESETS | web_runtime | `index.html:5096` | 508 | P2 | IN_PROGRESS | - |
| UI-CONFIG-PRESETS | web_runtime | `index.html:5604` | 185 | P2 | VERIFIED | EXT-05, COV-01 |
| UI-APP-INIT | web_runtime | `index.html:5789` | 172 | P1 | IN_PROGRESS | - |
| UI-PWA-LIFECYCLE | pwa | `index.html:5961` | 85 | P1 | IN_PROGRESS | - |
...
| UI-CSS-RESULTS | web_css | `lsp-dplanner-results.css:1` | 998 | P1 | IN_PROGRESS | REG-89, REG-90, REG-91, REG-92, REG-93, REG-94 |
| UI-MARKUP-HEADER | web_markup | `ui/markup-header.html:1` | 738 | P2 | IN_PROGRESS | - |
...
| UI-MODE-STATE | ui_core | `settings-core.js:419` | 621 | P2 | IN_PROGRESS | - |
| UI-UNIT-SWITCHING | web_runtime | `schedule-runner-core.js:414` | 372 | P1 | IN_PROGRESS | - |
| UI-ZHL-DELEGATES | web_runtime | `schedule-runner-core.js:786` | 141 | P0 | VERIFIED | REG-15, REG-16, REG-18 |
| UI-CCR-DELEGATES | web_runtime | `schedule-runner-core.js:927` | 370 | P0 | IN_PROGRESS | - |
| UI-DECO-PHYSICS | web_runtime | `schedule-runner-core.js:1297` | 232 | P0 | IN_PROGRESS | - |
| UI-SCHEDULE-INPUTS | web_runtime | `schedule-runner-core.js:1529` | 373 | P0 | IN_PROGRESS | - |
| UI-SETTINGS-CONTROLS | web_runtime | `schedule-runner-core.js:1902` | 428 | P1 | IN_PROGRESS | - |
| UI-VPM-RUNNER | web_runtime | `schedule-runner-core.js:2330` | 491 | P0 | IN_PROGRESS | REG-131, REG-132, REG-133, REG-134, REG-136, REG-138 |
| UI-ZHL-RUNNER-SETUP | web_runtime | `schedule-runner-core.js:2821` | 144 | P0 | IN_PROGRESS | - |
| UI-ZHL-RUNNER-ENGINE | web_runtime | `schedule-runner-core.js:2965` | 334 | P0 | IN_PROGRESS | REG-132, REG-134, REG-137 |
| UI-VPM-RENDER | ui_core | `results-render-core.js:330` | 504 | P1 | IN_PROGRESS | - |
| UI-ZHL-RESULTS | ui_core | `results-render-core.js:834` | 464 | P1 | IN_PROGRESS | - |
...
| APP-CONTINGENCY | ui_core | `contingency-core.js:1` | 594 | P1 | IN_PROGRESS | - |
| APP-EXPORT | ui_core | `export-core.js:1` | 3269 | P2 | IN_PROGRESS | - |
...
| APP-SERVICE-WORKER | pwa | `sw.js:1` | 302 | P1 | IN_PROGRESS | - |
...
| TEST-ENGINE-REGRESSION | test_infrastructure | `dev/engine_regression.py:1` | 2787 | P1 | IN_PROGRESS | - |
...
| TOOL-BUILD-PAGES | tooling | `tools/build_pages_site.py:1` | 148 | P2 | IN_PROGRESS | - |
...
| TOOL-CHECK-PARITY | tooling | `tools/check_engine_parity.py:1` | 312 | P1 | IN_PROGRESS | - |
| TOOL-RUN-AUDIT-COVERAGE-SUITE-PY | tooling | `tools/run_audit_coverage_suite.py:1` | 104 | P0 | IN_PROGRESS | - |
| TOOL-SEVEN-LENS-PROTOCOL | tooling | `tools/seven_lens_protocol.py:1` | 1406 | P0 | IN_PROGRESS | - |
...
| TOOL-EXTRACT-UI | tooling | `tools/extract_ui_cores.py:1` | 523 | P2 | IN_PROGRESS | - |
...
| TOOL-SYNC-WWW | tooling | `tools/sync_www.py:1` | 143 | P1 | IN_PROGRESS | - |
...
| UI-PLANNER-SHELL | ui_shell | `planner-shell.js:1` | 199 | P1 | IN_PROGRESS | REG-96, REG-99 |
| UI-RESULTS-PANEL | ui_shell | `results-panel.js:1` | 311 | P1 | IN_PROGRESS | COV-01, PARITY-01, EXT-02, REG-01, REG-95, REG-97, REG-98 |
...
| TOOL-V3-UI_ASSETS-PY | tooling | `tools/ui_assets.py:1` | 58 | P2 | IN_PROGRESS | - |
...
| TEST-UI-VISUAL-CONTRACT-REGRESSION | test_infrastructure | `dev/ui_visual_contract_regression.py:1` | 2144 | P0 | IN_PROGRESS | REG-100, REG-101, REG-102, REG-103, REG-104, REG-105, REG-106, REG-107, REG-108, REG-109, REG-110, REG-111, REG-131, REG-132, REG-133, REG-134, REG-135, REG-136, REG-137, REG-138 |
