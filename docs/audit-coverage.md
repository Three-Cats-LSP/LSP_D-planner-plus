...
| UI-PROFILE-PRESETS | web_runtime | `index.html:8584` | 514 | P2 | IN_PROGRESS | - |
| UI-CONFIG-PRESETS | web_runtime | `index.html:9098` | 185 | P2 | VERIFIED | EXT-05, COV-01 |
| UI-APP-INIT | web_runtime | `index.html:9283` | 175 | P1 | VERIFIED | EXT-05, COV-01 |
| UI-PWA-LIFECYCLE | pwa | `index.html:9458` | 99 | P1 | VERIFIED | REG-45, EXT-08, COV-01 |
