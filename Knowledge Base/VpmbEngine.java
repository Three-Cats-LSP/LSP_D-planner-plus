 ...
 * Simulates bubble dynamics, critical volume gradients, and tissue 
 * gas loading without Bühlmann/GFS hybrid mixing.
 */
public class VpmbEngine {
    ...
    public VpmbEngine() {
        ...
        for (int i = 0; i < NUM_COMPARTMENTS; i++) {
            compartments.add(new Compartment(HT_N2[i], HT_HE[i]));
        }
    }
    ...
    private double getEnforcedCeilingMeters(double currentAmbientPa, double stopTimeMin) {
        ...
        double calculatedMeters = (maxVpmCeilingPa - ATM) / 10000.0;
    ...
    public void generateAscentSchedule(double startDepthMeters, GasMix bottomGas, GasMix decoGas, double gasSwitchDepth) {
        System.out.println("\n========================================================");
        System.out.println("          RUNNING PURE VPM-B ENGINE SIMULATION          ");
        System.out.println("========================================================");
    ...
    public static void main(String[] args) {
        VpmbEngine engine = new VpmbEngine();
